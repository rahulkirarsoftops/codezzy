...
import './index.css';
import logo from "../../assets/PNG/dark-logo.png"
    ...
    return (
        <footer className="">
            <div className='footer'>
                <div className='footer-wrapper'>
                    ...
                    <div className='social-icon'>
                        ...
                        <div>
                            <a href='https://in.pinterest.com/#save' target='_blank'>
            ...
            <div className='footer-bottom'>
                <div className='copyride'>© Copyright CodeZzy Template All rights reserved.Crafted by <a href='https://www.softopstechnologies.com/' target='_blank' className='link'><span>SoftOps Technologies</span></a></div>
                <div className='bottom-nav'>
                    <ul>
                        <li className='list-inline-item'>
                            <NavLink to="/" style={({ isActive }) =>
                                (isActive ? { color: "#27AD96" } : { color: "#535967", textDecoration: "none" })}>
                                Home
                            </NavLink>
                        </li>
                        <li className='list-inline-item'>
